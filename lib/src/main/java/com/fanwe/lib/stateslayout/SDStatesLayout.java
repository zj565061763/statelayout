 ...
 */
public class SDStatesLayout extends FrameLayout implements View.OnClickListener
{
    public SDStatesLayout(Context context)
    {
        super(context);
        init(null);
    }

    public SDStatesLayout(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(attrs);
    }

    public SDStatesLayout(Context context, AttributeSet attrs, int defStyleAttr)
    {
    ...
    public static SDStatesLayout wrap(View view)
    {
        if (view == null)
        {
            return null;
        ...
        SDStatesLayout statesLayout = new SDStatesLayout(view.getContext());
    ...
    public SDStatesLayout setCallback(Callback callback)
    {
        mCallback = callback;
        return this;
    }
